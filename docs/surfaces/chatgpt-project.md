...
4. Confirm the Project supports at least 13 files. The full package requires Go, Plus, Pro, Edu, Business, or Enterprise. Free Projects allow only 5 files and cannot install this edition as documented.
