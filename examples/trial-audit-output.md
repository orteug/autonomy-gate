...
- [x] 6 months pass without a recertification review of the human verification process — review by [date: December 2026]
...
- [x] Error rate exceeds 10% of shortlists requiring significant recruiter revision
- [x] 6 months pass without a recertification review — review by [date: December 2026]; include a diversity audit of shortlist vs. applicant pool outcomes
...
- [x] Error rate exceeds 10% of weekly runs requiring manual correction — review the template and data source definitions
- [x] 6 months pass without a recertification review — review by [date: December 2026]; confirm data source views are still accurate and alert thresholds are still calibrated
