...
**Step 1 — Read the artifact before creating the project**

The Gate's Project Setup Brief or Control Plan is the specification. It contains:
...
**Step 3 — Set custom instructions from the artifact**

Paste the CUSTOM INSTRUCTIONS block from the artifact verbatim. Do not paraphrase or simplify — the instructions encode the constraints issued by the Gate.
